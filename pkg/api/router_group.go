...
// GET registers a GET handler on the given path.
func (g *RouterGroup) GET(path string, handler app.HandlerFunc) {
	g.inner.GET(path, handler)
}

// POST registers a POST handler on the given path.
func (g *RouterGroup) POST(path string, handler app.HandlerFunc) {
	g.inner.POST(path, handler)
}

// PUT registers a PUT handler on the given path.
func (g *RouterGroup) PUT(path string, handler app.HandlerFunc) {
	g.inner.PUT(path, handler)
}

// DELETE registers a DELETE handler on the given path.
func (g *RouterGroup) DELETE(path string, handler app.HandlerFunc) {
